...
class Gesture
{
	...
	public
	void drawGesture(JPanel Obj, Graphics g, Point center, boolean feedback, int offset)
	{
	...
	public
	Point getRectPoint(Rectangle rect)
	{
	...
	public
	void setLabelBounds(Point center, int height, int width, int offset)
	{
	...
	public
	int[] getXCoordinates(int translation)
	{
	...
	public
	int[] getYCoordinates(int translation)
	{
		int[] coordinates = new int[curve.curvePoints.size()];
		for (int i = 0; i < curve.curvePoints.size(); i++)
		{
